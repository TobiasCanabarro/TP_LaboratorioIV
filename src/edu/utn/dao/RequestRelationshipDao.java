...
public class RequestRelationshipDao extends DataAccess implements Dao{
    ...
    private static final String SELECT_ALL_FRIEND_REQUEST_RELATIONSHIP = "SELECT r.id_user_receive, r.id_user_send FROMm lab.request_relationship AS r" +
            " WHERE r.id_user_receive = 14 or r.id_user_send = 14 AND r.state = true";
